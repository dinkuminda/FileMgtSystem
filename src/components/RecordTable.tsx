              ...
              records.map((record) => (
                <tr key={record.id} className="hover:bg-slate-50/50 transition-colors group">
                  ...
                  <td className="px-6 py-6 text-right">
                    <TableActions record={record} onEdit={onEdit} onDelete={onDelete} canEdit={canEdit} onView={setViewingRecord} />
                  </td>
                </tr>
              ))
            )}
  ...
  return (
    <div className="flex items-center justify-end gap-1">
      <button 
        ...
        className="p-2.5 text-slate-400 hover:text-[var(--m3-primary)] hover:bg-[var(--m3-primary-container)]/30 rounded-xl transition-all cursor-pointer border-none bg-transparent"
        title="View Details"
      >
      ...
      {canEdit && (
        <>
          <button 
            ...
            className="p-2.5 text-slate-300 hover:text-[var(--m3-primary)] hover:bg-[var(--m3-primary-container)]/30 rounded-xl transition-all cursor-pointer border-none bg-transparent"
            title="Edit Record"
          >
          ...
          <button 
            ...
            className="p-2.5 text-slate-300 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all cursor-pointer border-none bg-transparent"
            title="Delete Record"
          >
