...
import { Shield, Key, Loader2, Search, CheckCircle, AlertCircle, UserCog, Calendar, Clock, Mail, Users } from 'lucide-react';
    ...
    <div className="p-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Manage system users and view authentication status</p>
        </div>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div className="flex lg:justify-end">
                  <button 
                    ...
                    className="w-full lg:w-auto flex items-center justify-center space-x-2 text-xs font-black uppercase tracking-widest text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 hover:bg-blue-600 hover:text-white px-6 py-4 rounded-2xl transition-all shadow-sm"
                  >
